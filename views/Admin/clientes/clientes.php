...
<body class="bg-gris font-inter text-secondary min-h-screen flex overflow-hidden">
    ...
    <main class="flex-1 h-screen overflow-y-auto">
        ...
        <header class="bg-white px-8 py-4 border-b border-gray-200 flex items-center justify-between">
            <div>
                <h2 class="text-[26px] font-bold text-secondary">Clientes</h2>
        ...
        <div class="px-8 py-6">
            ...
            <div class="container">
                ...
                <?php while($c = $clientes->fetch_assoc()){ 
                    ...
                    // ✅ AHORA USAMOS "motivo" QUE ES EL NOMBRE REAL DE TU COLUMNA
                    $estado = isset($c['motivo']) ? $c['motivo'] : 'activo';
                ...
                <?php if ($estado == 'activo'): ?>
                    <a class="btn-estado desactivar" href="cambiar_estado.php?id=<?= $c['id_clientes'] ?>&estado=inactivo">Desactivar</a>
                <?php else: ?>
                    <a class="btn-estado activar" href="cambiar_estado.php?id=<?= $c['id_clientes'] ?>&estado=activo">Activar</a>
                <?php endif; ?>
